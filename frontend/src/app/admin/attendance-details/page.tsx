...
import { ArrowLeft, Calendar as CalendarIcon, Search, CheckCircle2, XCircle, Clock, CalendarOff } from "lucide-react";
...
const STATUS_ICONS: Record<Status, React.ReactNode> = {
  ...
  absent: <XCircle size={24} />,
  half_day: <Clock size={24} />,
  leave: <CalendarOff size={24} />
};
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "16px", marginBottom: "32px" }}>
          <button 
            ...
            style={{ 
              ...
              justifyContent: "center", boxShadow: "0 2px 4px rgba(0,0,0,0.04)", transition: "all 0.2s ease" 
            }}
          ...
          {Object.entries(totals).map(([key, count]) => {
            ...
            return (
              ...
              >
                ...
                <div style={{ position: "absolute", top: 0, right: 0, width: "100px", height: "100px", background: `radial-gradient(circle at top right, ${color}20, transparent 70%)`, opacity: 0.6 }}></div>
                ...
                <p style={{ margin: 0, fontSize: "2.5rem", fontWeight: 700, color: "#111827", lineHeight: 1 }}>
                  {count}
                </p>
                <p style={{ margin: "8px 0 0", fontSize: "0.9rem", fontWeight: 600, color: "#6b7280", textTransform: "uppercase", letterSpacing: "0.5px" }}>
              ...
              {busy ? (
                ...
                attendance.map((record, idx) => {
                  ...
                  return (
                    <tr 
                      key={idx} 
                      style={{ borderTop: "1px solid #e5e7eb", transition: "background-color 0.15s ease" }}
                    ...
                    >
                      ...
                      <td style={{ padding: "16px" }}>
                        <span style={{ 
                          ...
                          padding: "6px 12px", borderRadius: "24px", fontSize: "0.85rem", fontWeight: 600,
                          ...
                          <span style={{ width: "6px", height: "6px", borderRadius: "50%", backgroundColor: STATUS_COLORS[statusKey], boxShadow: `0 0 4px ${STATUS_COLORS[statusKey]}` }}></span>
                          {STATUS_LABELS[statusKey]}
                        </span>
                      </td>
...
export default function EmployeeAttendancePage() {
  return (
    <Suspense fallback={<AdminShell><div style={{ padding: "40px", textAlign: "center" }}>Loading...</div></AdminShell>}>
